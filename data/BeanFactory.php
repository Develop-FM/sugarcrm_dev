...
class BeanFactory
{
    ...
    /**
     * Returns a SugarBean object by id. The Last 10 loaded beans are cached in memory to prevent multiple retrieves
     * per request. If no id is passed, a new bean is created.
     *
     * @param string $module
     * @param string $id
