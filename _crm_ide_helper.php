 ...
 * Generated for SugarCRM 6.5.22 on 2016-01-21.
 *
 ...
 * @property string id_name The unique id of the module
 * @property string date_entered Date of upgrade or module load
 * @property string name 
 * @property string manifest A serialized copy of the manifest file.
 * @property string version Version as contained in manifest file
 * @property string filename Cached filename containing the upgrade scripts and content
 * @property string md5sum The MD5 checksum of the upgrade file
 * @property string type The upgrade type (module, patch, theme, etc)
 * @property string status The status of the upgrade (ex:  "installed")
 * @property string id Unique identifier
 *
 *
 */
class UpgradeHistory {
	...
	/** 
	 * @var string Date of upgrade or module load
	 */
	 public $date_entered;
	...
	/** 
	 * @var string A serialized copy of the manifest file.
	 */
	 public $manifest;

	/** 
	 * @var string Version as contained in manifest file
	 */
	 public $version;

	/** 
	 * @var string Cached filename containing the upgrade scripts and content
	 */
	 public $filename;

	/** 
	 * @var string The MD5 checksum of the upgrade file
	 */
	 public $md5sum;

	/** 
	 * @var string The upgrade type (module, patch, theme, etc)
	 */
	 public $type;

	/** 
	 * @var string The status of the upgrade (ex:  "installed")
	 */
	 public $status;
 ...
 * @property bool massupdate 
 * @property bool reportable 
 * @property bool audited 
 * @property string duplicate_merge 
 * @property string importable 
 ...
 * @property string email_address_caps 
 * @property string id 
 *
 *
 */
 ...
 *
 * @property bool deleted Record deletion indicator
 * @property string bean_id ID of item identified by bean_type
 * @property string bean_type Bean type for which import occurs
 * @property string import_module Module for which import occurs
...
class UsersLastImport {
	...
	/** 
	 * @var string ID of item identified by bean_type
	 */
	 public $bean_id;

	/** 
	 * @var string Bean type for which import occurs
	 */
	 public $bean_type;

	/** 
	 * @var string Module for which import occurs
	 */
