...
$dictionary['opportunities_contacts'] = [
    ...
    'indices'       => [
        ['name' => 'opportunities_contactspk', 'type' => 'primary', 'fields' => ['id']],
        ['name' => 'idx_con_opp_con', 'type' => 'index', 'fields' => ['contact_id']],
        ['name' => 'idx_con_opp_opp', 'type' => 'index', 'fields' => ['opportunity_id']],
        [
