...
$dictionary['accounts_opportunities'] = [
    ...
    'indices'       => [
        ['name' => 'accounts_opportunitiespk', 'type' => 'primary', 'fields' => ['id']],
        ['name' => 'idx_account_opportunity', 'type' => 'alternate_key', 'fields' => ['account_id', 'opportunity_id']],
        ['name' => 'idx_oppid_del_accid', 'type' => 'index', 'fields' => ['opportunity_id', 'deleted', 'account_id']]
    ],
    'relationships' => [
