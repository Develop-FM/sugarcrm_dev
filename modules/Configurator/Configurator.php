...
class Configurator
{
	 ...
	 * @params : none
	 *
	 * @return : An array of logger configuration properties including log size, file extensions etc. See SugarLogger
	 *           for more details. Parses the old logger settings from the log4php.properties files.
	 *
	 */
