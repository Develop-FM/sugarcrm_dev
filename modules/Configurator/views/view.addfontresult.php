...
class ConfiguratorViewAddFontResult extends SugarView
{
    ...
    public function display()
    {
        ...
        $this->ss->assign("MODULE_TITLE", getClassicModuleTitle($mod_strings['LBL_MODULE_ID'], [$mod_strings['LBL_ADDFONTRESULT_TITLE']], false));
        if ($error) {
...
//display
    ...
    private function addFont()
    {
        ...
        if (! $error) {
            ...
            $error       = $fontManager->addFont($uploadFileNames["pdf_font_file"], $uploadFileNames["pdf_metric_file"], $_REQUEST['pdf_embedded'], $_REQUEST['pdf_encoding_table'], [], htmlspecialchars_decode($_REQUEST['pdf_cidinfo'], ENT_QUOTES), $_REQUEST['pdf_style_list']);
