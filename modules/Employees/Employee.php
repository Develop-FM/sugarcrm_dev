...
class Employee extends Person
{
	...
	var $encodeFields = ["first_name", "last_name", "description"];

	// This is used to retrieve related fields from form posts.
	var $additional_column_fields = ['reports_to_name'];
	...
	*/
	 ...
	 * function.
	 *
	 * We overrode this function in the Employees module to add the additional filter check so that we do not retrieve
	 * portal users for the Employees list view queries
	 *
