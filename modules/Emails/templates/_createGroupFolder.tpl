...
<script type="text/javascript" src="storage/cache/include/javascript/sugar_grp1_yui.js?v={VERSION_MARK}"></script>
<script type="text/javascript" src="include/SugarFields/Teamset/Teamset.js?v={VERSION_MARK}"></script>
{$languageStrings}
<script type="text/javascript" src="storage/cache/include/javascript/sugar_grp1_yui.js??v={VERSION_MARK}"></script>
<script type="text/javascript" src="storage/cache/include/javascript/sugar_grp1.js??v={VERSION_MARK}"></script>
