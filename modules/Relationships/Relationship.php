...
class Relationship extends SugarBean
{
    ...
    /**
     * @return true if the relationship is self referencing. equality check is performed for both table and key names.
     */
     ...
     * @param DBManager $db
     *
     * @return bool|true if a relationship with provided name exists
     */
