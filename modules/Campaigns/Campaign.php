...
class Campaign extends SugarBean
{
	...
	function track_log_entries($type = [])
	{
	...
	function get_queue_items()
	{
		...
		$man       = new EmailMan();
		$listquery = $man->create_queue_items_query('', str_replace([
			"WHERE",
			"where"
		], "", $query_array['where']), null, $query_array);
...
//	}
	 ...
	 *
	 */
	function create_list_count_query($query, $params = [])
	{
