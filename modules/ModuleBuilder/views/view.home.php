...
class ViewHome extends SugarView
{
	...
	function generateHomeButtons()
	{
		...
		if (displayStudioForCurrentUser() == true) {
			...
			$this->buttons[$GLOBALS['mod_strings']['LBL_STUDIO']] = ['action'     => 'javascript:ModuleBuilder.main("studio")',
																	 'imageTitle' => 'Studio',
																	 'size'       => '128',
																	 'help'       => 'studioBtn'
			];
		...
		if (is_admin($current_user)) {
			$this->buttons[$GLOBALS['mod_strings']['LBL_MODULEBUILDER']] = ['action'     => 'javascript:ModuleBuilder.main("mb")',
																			'imageTitle' => 'ModuleBuilder',
																			'size'       => '128',
																			'help'       => 'mbBtn'
			];
		}
		$this->buttons[$GLOBALS['mod_strings']['LBL_DROPDOWNEDITOR']] = ['action'     => 'javascript:ModuleBuilder.main("dropdowns")',
																		 'imageTitle' => $GLOBALS['mod_strings']['LBL_HOME_EDIT_DROPDOWNS'],
																		 'imageName'  => 'DropDownEditor',
																		 'size'       => '128',
																		 'help'       => 'dropDownEditorBtn'
		];
	}
}