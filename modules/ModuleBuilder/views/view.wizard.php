...
class ModuleBuilderViewWizard extends SugarView
{
    ...
    function generateMBDashletButtons()
    {
        ...
        $this->buttons [$GLOBALS ['mod_strings']['LBL_DASHLETSEARCHVIEW']] = [
            'action'     => "module=ModuleBuilder&MB=true&action=editLayout&view=dashletsearch&view_module={$this->editModule}&view_package={$this->package}",
    ...
    {
        $this->buttons [$GLOBALS ['mod_strings']['LBL_POPUPLISTVIEW']] = [
            'action'     => "module=ModuleBuilder&action=editLayout&view=popuplist&view_module={$this->editModule}&view_package={$this->package}",
            'imageTitle' => $GLOBALS ['mod_strings']['LBL_POPUPLISTVIEW'],
            'imageName'  => 'ListView',
            'help'       => 'PopupListViewBtn'
        ];

        $this->buttons [$GLOBALS ['mod_strings']['LBL_POPUPSEARCH']] = [
            'action'     => "module=ModuleBuilder&action=editLayout&view=popupsearch&view_module={$this->editModule}&view_package={$this->package}",
    ...
    function generateStudioDashletButtons()
    {
        ...
        $this->buttons [$GLOBALS ['mod_strings']['LBL_DASHLETSEARCHVIEW']] = [
            'action'     => "module=ModuleBuilder&action=editLayout&view=dashletsearch&view_module={$this->editModule}",
            'imageTitle' => $GLOBALS ['mod_strings']['LBL_DASHLETSEARCHVIEW'],
            'imageName'  => 'BasicSearch',
            'help'       => 'DashletSearchViewBtn'
        ];
    ...
    {
        $this->buttons [$GLOBALS ['mod_strings']['LBL_POPUPLISTVIEW']] = [
            'action'     => "module=ModuleBuilder&action=editLayout&view=popuplist&view_module={$this->editModule}",
            'imageTitle' => $GLOBALS ['mod_strings']['LBL_POPUPLISTVIEW'],
            'imageName'  => 'ListView',
            'help'       => 'PopupListViewBtn'
        ];
        ...
        $this->buttons [$GLOBALS ['mod_strings']['LBL_POPUPSEARCH']] = [
            'action'     => "module=ModuleBuilder&action=editLayout&view=popupsearch&view_module={$this->editModule}",
            'imageTitle' => $GLOBALS ['mod_strings']['LBL_POPUPSEARCH'],
            'imageName'  => 'BasicSearch',
            'help'       => 'PopupSearchViewBtn'
        ];
    ...
    function generateMBSearchButtons()
    {
        ...
        $this->buttons [$GLOBALS ['mod_strings'] ['LBL_ADVANCED']] = [
            'action'     => "module=ModuleBuilder&MB=true&action=editLayout&view_module={$this->editModule}&view_package={$this->package}&view=SearchView&searchlayout=advanced_search",
