...
class ModuleBuilderViewWizard extends SugarView
{
	...
	function __construct()
	{
		...
		$this->buttons    = []; // initialize so that modules without subpanels for example don't result in this being unset and causing problems in the smarty->assign
	}
	...
	function generateStudioModuleButtons()
	{
		...
		foreach ($nodes as $module) {
			$this->buttons [$module ['name']] = ['action'     => $module ['action'],
	...
	{
		$this->buttons [$GLOBALS ['mod_strings']['LBL_DASHLETLISTVIEW']]   = [
			'action'     => "module=ModuleBuilder&MB=true&action=editLayout&view=dashlet&view_module={$this->editModule}&view_package={$this->package}",
			'imageTitle' => $GLOBALS ['mod_strings']['LBL_DASHLETLISTVIEW'],
			'imageName'  => 'ListView',
			'help'       => 'DashletListViewBtn'
		];
		$this->buttons [$GLOBALS ['mod_strings']['LBL_DASHLETSEARCHVIEW']] = ['action'     => "module=ModuleBuilder&MB=true&action=editLayout&view=dashletsearch&view_module={$this->editModule}&view_package={$this->package}",
	...
	{
		$this->buttons [$GLOBALS ['mod_strings']['LBL_POPUPLISTVIEW']] = ['action'     => "module=ModuleBuilder&action=editLayout&view=popuplist&view_module={$this->editModule}&view_package={$this->package}",
																		  'imageTitle' => $GLOBALS ['mod_strings']['LBL_POPUPLISTVIEW'],
																		  'imageName'  => 'ListView',
																		  'help'       => 'PopupListViewBtn'
		];
		$this->buttons [$GLOBALS ['mod_strings']['LBL_POPUPSEARCH']]   = ['action'     => "module=ModuleBuilder&action=editLayout&view=popupsearch&view_module={$this->editModule}&view_package={$this->package}",
	...
	{
		$this->buttons [$GLOBALS ['mod_strings']['LBL_DASHLETLISTVIEW']]   = [
			'action'     => "module=ModuleBuilder&action=editLayout&view=dashlet&view_module={$this->editModule}",
			'imageTitle' => $GLOBALS ['mod_strings']['LBL_DASHLETLISTVIEW'],
			'imageName'  => 'ListView',
			'help'       => 'DashletListViewBtn'
		];
		$this->buttons [$GLOBALS ['mod_strings']['LBL_DASHLETSEARCHVIEW']] = ['action'     => "module=ModuleBuilder&action=editLayout&view=dashletsearch&view_module={$this->editModule}",
																			  'imageTitle' => $GLOBALS ['mod_strings']['LBL_DASHLETSEARCHVIEW'],
																			  'imageName'  => 'BasicSearch',
																			  'help'       => 'DashletSearchViewBtn'
		];
	...
	{
		$this->buttons [$GLOBALS ['mod_strings']['LBL_POPUPLISTVIEW']] = ['action'     => "module=ModuleBuilder&action=editLayout&view=popuplist&view_module={$this->editModule}",
																		  'imageTitle' => $GLOBALS ['mod_strings']['LBL_POPUPLISTVIEW'],
																		  'imageName'  => 'ListView',
																		  'help'       => 'PopupListViewBtn'
		];
		$this->buttons [$GLOBALS ['mod_strings']['LBL_POPUPSEARCH']]   = ['action'     => "module=ModuleBuilder&action=editLayout&view=popupsearch&view_module={$this->editModule}",
																		  'imageTitle' => $GLOBALS ['mod_strings']['LBL_POPUPSEARCH'],
																		  'imageName'  => 'BasicSearch',
																		  'help'       => 'PopupSearchViewBtn'
		];
	...
	{
		$this->buttons [$GLOBALS ['mod_strings'] ['LBL_BASIC']]    = [
			'action'     => "module=ModuleBuilder&MB=true&action=editLayout&view_module={$this->editModule}&view_package={$this->package}&view=SearchView&searchlayout=basic_search",
			'imageTitle' => $GLOBALS ['mod_strings'] ['LBL_BASIC_SEARCH'],
			'imageName'  => 'BasicSearch',
			'help'       => "BasicSearchBtn"
		];
		$this->buttons [$GLOBALS ['mod_strings'] ['LBL_ADVANCED']] = ['action'     => "module=ModuleBuilder&MB=true&action=editLayout&view_module={$this->editModule}&view_package={$this->package}&view=SearchView&searchlayout=advanced_search",
