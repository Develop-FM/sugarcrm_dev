...
echo getClassicModuleTitle(translate('LBL_MODULE_NAME', 'Administration'), [translate('LBL_MODULE_NAME', 'Administration')], false);

//get the module links..
require(DOCROOT.'modules/Administration/metadata/adminpaneldefs.php');
