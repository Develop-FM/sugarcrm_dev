...
$admin_option_defs['Administration']['support'] = [
    'Support',
    'LBL_SUPPORT_TITLE',
    'LBL_SUPPORT',
    './index.php?module=Administration&action=SupportPortal&view=support_portal'
];

$admin_option_defs['Administration']['update']        = [
    'sugarupdate',
    'LBL_SUGAR_UPDATE_TITLE',
    'LBL_SUGAR_UPDATE',
    './index.php?module=Administration&action=Updater'
];
$admin_option_defs['Administration']['documentation'] = [
    'OnlineDocumentation',
    'LBL_DOCUMENTATION_TITLE',
    'LBL_DOCUMENTATION',
...
$admin_group_header[] = ['LBL_SUGAR_NETWORK_TITLE', '', false, $admin_option_defs, 'LBL_SUGAR_NETWORK_DESC'];
...
require_once DOCROOT.'include/SugarOAuthServer.php';
if (SugarOAuthServer::enabled()) {
    $admin_option_defs['Administration']['oauth'] = [
        'Password',
        'LBL_OAUTH_TITLE',
        'LBL_OAUTH',
...
if (file_exists($path = DOCROOT.'custom/modules/Administration/Ext/Administration/administration.ext.php')) {
    include($path);
}
