...
class Controller extends SugarBean
{
    ...
    /**
     * defines id this is a new list order or existing, or delete
     *
     * @var string
     */
    var $type;
    ...
    /**
     * @param SugarBean $seed_object
     * @param string $type
     */
    function init(SugarBean & $seed_object, $type)
    {
     ...
     * @param string $affected_new_x
     * @param string $affected_new_y
     */
    function update_affected_order($affected_id, $affected_new_x = "", $affected_new_y = "")
    {
        ...
        $this->db->query($query, true, " Error updating affected order id: ");
    }

    /**
     * @param string $parent_id
     * @param string $list_order_x
     * @param string $list_order_y
     *
     * @return string
     */
    ...
    function delete_adjust_order($parent_id)
    {
        ...
        $this->db->query($query, true, " Error updating the delete_adjust_order: ");
    }
}