...
class SugarHtml
{
     ...
     */
    public static function createOpenTag($tagName, $params = [], $self_closing = false)
    {
     ...
     * @return string - generated html string
     */
    public static function createHtml($dom_tree = [])
    {
        $out = "";
    ...
    /**
     * @param array $sugar_html
     *
     * @return array
     */
    public static function parseSugarHtml($sugar_html = [])
    {
        $output      = [];
        $input_types = [
            'submit',
     ...
     */
    public static function parseHtmlTag($code, $appendTo = [])
    {
        $code      = ltrim($code);
        ...
        return (empty($appendTo)) ? $output : array_merge($appendTo, [$output]);
    }
    ...
    public static function parseSmartyTag($code, &$output, &$offset = 0, $is_attr = false)
    {
        ...
        $clauses = array_slice(//split into each clause
            preg_split("/[\{\}]/i", $smarty_string), 1, -1 //slice out the first and last items, which is empty.
        );
