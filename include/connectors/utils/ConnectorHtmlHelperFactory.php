...
{
    const CONNECTOR_HTML_HELPER_MAIN = DOCROOT.'include/connectors/utils/ConnectorHtmlHelper.php';
    const CONNECTOR_HTML_HELPER_CUSTOM = DOCROOT.'custom/include/connectors/utils/ConnectorHtmlHelper.php';
