...
class ConnectorHtmlHelper
{
    ...
    {
        require_once(DOCROOT.'include/connectors/formatters/FormatterFactory.php');
    ...
    private function getButton(array $shown_sources, $module, $smarty)
    {
        ...
        foreach ($shown_sources as $id) {
            ...
            if (! empty($formatter_code)) {
                ...
                $code .= '<!--not_in_theme!--><img id="dswidget_img" border="0" src="'.$iconFilePath.'" alt="'.$id.'" onclick="show_'.$id.'(event);">';
