...
class contextMenu
{
     ...
     *                       helptext - Additional instructional text to accompany the text for a MenuItem. Example: If
     *                       the text is
     *                       "Copy" you might want to add the help text "Ctrl + C" to inform the user there is a
     *                       keyboard shortcut for the item. emphasis - If set to true the text for the MenuItem will
     *                       be rendered with emphasis (using <em>). strongemphasis - If set to true the text for the
     *                       MenuItem will be rendered with strong emphasis (using <strong>). disabled - If set to true
     *                       the MenuItem will be dimmed and will not respond to user input or fire events. selected -
     *                       If set to true the MenuItem will be highlighted. submenu - Appends / removes a menu (and
     *                       it's associated DOM elements) to / from the MenuItem. checked - If set to true the
     *                       MenuItem will be rendered with a checkmark.
     */
    ...
    function loadFromFile($name)
    {
        ...
        require_once(DOCROOT."include/contextMenus/menuDefs/{$name}.php");
     ...
     */
    function loadFromDef($name, array $defs)
    {
