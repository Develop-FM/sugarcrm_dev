...
$searchFields[$module_name] = [
    ...
    'search_name'               => [
        'query_type'          => 'default',
        'db_field'            => ['first_name', 'last_name'],
        'force_unifiedsearch' => true
    ],
    'do_not_call'               => ['query_type' => 'default', 'input_type' => 'checkbox', 'operator' => '='],
    'phone'                     => [
        'query_type' => 'default',
        'db_field'   => ['phone_mobile', 'phone_work', 'phone_other', 'phone_fax', 'assistant_phone']
    ],
    'email'                     => [
        'query_type' => 'default',
        'operator'   => 'subquery',
    ...
    'address_street'            => [
        'query_type' => 'default',
        'db_field'   => ['primary_address_street', 'alt_address_street']
    ],
    'address_city'              => [
        'query_type' => 'default',
        'db_field'   => ['primary_address_city', 'alt_address_city']
    ],
    'address_state'             => [
        'query_type' => 'default',
        'db_field'   => ['primary_address_state', 'alt_address_state']
    ],
    'address_postalcode'        => [
        'query_type' => 'default',
        'db_field'   => ['primary_address_postalcode', 'alt_address_postalcode']
    ],
    'address_country'           => [
        'query_type' => 'default',
        'db_field'   => ['primary_address_country', 'alt_address_country']
    ],
    'current_user_only'         => [
        'query_type' => 'default',
