...
class Person extends Basic
{
    ...
    /**
     * Сontrols whether or not to invoke the getLocalFormatttedName method with title and salutation
     *
     * @var bool
     */
    ...
    public function _create_proper_name_field()
    {
        ...
        if (isset($this->field_defs['salutation']['options']) && isset($app_list_strings[$this->field_defs['salutation']['options']]) && isset($app_list_strings[$this->field_defs['salutation']['options']][$this->salutation])) {
