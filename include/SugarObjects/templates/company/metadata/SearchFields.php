...
$searchFields[$module_name] = [
    ...
    'address_street'            => [
        'query_type' => 'default',
        'db_field'   => ['billing_address_street', 'shipping_address_street']
    ],
    'address_city'              => [
        'query_type' => 'default',
        'db_field'   => ['billing_address_city', 'shipping_address_city']
    ],
    'address_state'             => [
        'query_type' => 'default',
        'db_field'   => ['billing_address_state', 'shipping_address_state']
    ],
    'address_postalcode'        => [
        'query_type' => 'default',
        'db_field'   => ['billing_address_postalcode', 'shipping_address_postalcode']
    ],
    'address_country'           => [
        'query_type' => 'default',
        'db_field'   => ['billing_address_country', 'shipping_address_country']
    ],
