...
class LanguageManager
{
     ...
     *
     * @param string $module - the name of the module we are working with
     * @param array  $templates
     * @param bool   $refresh
     */
    function createLanguageFile($module, $templates = ['default'], $refresh = false)
    {
     ...
     * @param string $lang               - current language this module use
     * @param string $loaded_mod_strings - the string that we will add the module template language  into
     *
     * @return array
     */
     ...
     */
    function saveCache($module, $lang, $loaded_mod_strings, $additonal_objects = [])
    {
        if (empty($lang)) {
            $lang = $GLOBALS['sugar_config']['default_language'];
        }
     ...
     *
     * @param string $module_dir the module_dir to clear, if not specified then clear language cache for all modules.
     ...
     *                                        to search
     */
    function refreshLanguage($module, $lang, $loaded_mod_strings = [], $additional_search_paths = null)
    {
