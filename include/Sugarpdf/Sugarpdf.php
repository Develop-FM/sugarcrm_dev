...
class Sugarpdf extends TCPDF
{
     ...
     */
    function __construct($bean = null, $sugarpdf_object_map = [], $orientation = PDF_PAGE_ORIENTATION, $unit = PDF_UNIT, $format = PDF_PAGE_FORMAT, $unicode = true, $encoding = 'UTF-8', $diskcache = false)
    {
        global $locale;
    ...
    /**
     * [OVERRIDE]
     * This method override the regular Header() method to enable the custom image directory in addition to the OOB
     * image directory. This method is used to render the page header. It is automatically called by AddPage().
     * @access public
     ...
     * This method override the regular SetFont() method to enable the custom font directory in addition to the OOB
     * font directory.
     *
     * @param string $family   Family font. It can be either a name defined by AddFont() or one of the standard Type1
     *                         families (case insensitive):<ul><li>times (Times-Roman)</li><li>timesb
     *                         (Times-Bold)</li><li>timesi (Times-Italic)</li><li>timesbi
     *                         (Times-BoldItalic)</li><li>helvetica (Helvetica)</li><li>helveticab
     *                         (Helvetica-Bold)</li><li>helveticai (Helvetica-Oblique)</li><li>helveticabi
     *                         (Helvetica-BoldOblique)</li><li>courier (Courier)</li><li>courierb
     *                         (Courier-Bold)</li><li>courieri (Courier-Oblique)</li><li>courierbi
     *                         (Courier-BoldOblique)</li><li>symbol (Symbol)</li><li>zapfdingbats
     *                         (ZapfDingbats)</li></ul> It is also possible to pass an empty string. In that case, the
     *                         current family is retained.
     * @param string $style    Font style. Possible values are (case insensitive):<ul><li>empty string:
     *                         regular</li><li>B: bold</li><li>I: italic</li><li>U: underline</li><li>D: line
     *                         trough</li></ul> or any combination. The default value is regular. Bold and italic
     *                         styles do not apply to Symbol and ZapfDingbats basic fonts or other fonts when not
     *                         defined.
     * @param float  $size     Font size in points. The default value is the current size. If no size has been
     *                         specified since the beginning of the document, the value taken is 12
     * @param string $fontfile The font definition file. By default, the name is built from the family and style, in
     ...
     * cell options override the regular options for the specific cell - Array[line number (0 to x)][cell
     * header]['options']
     *
     ...
     * @param $options Array which can contain : width (array 'column name'=>'width value + % OR nothing'), isheader
     *                 (bool), header (array), fill (string: HTML color), ishtml (bool) default: false, border (0: no
     *                 border (defaul), 1: frame or all of the following characters: L ,T ,R ,B), align (L: left align,
     *                 C: center, R: right align, J: justification), stretch (array 'column name'=>stretch type)
     *
     * @see MultiCell()
     */
     ...
     * @param $options    Array which can contain : table (array of "HTML proprty"=>"value"),td (array of "HTML
     *                    proprty"=>"value"), tr (array of "HTML proprty"=>"value"), isheader(bool), header (array of
     *                    "HTML proprty"=>"value"), width (array 'column name'=>'width value + unit OR nothing')
     *
     ...
     *
     * @param array $line  Array containing the data of all the cells of the line
     * @param array $width Array containing the width of all the cells of the line
     *
     * @return int The heigth of the line
     */
