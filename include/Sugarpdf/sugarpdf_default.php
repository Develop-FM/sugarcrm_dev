...
$sugarpdf_default = [
    ...
    "PDF_PAGE_ORIENTATION_LIST"     => implode(",", ["P" => "P", "L" => "L"]),
    ...
    "PDF_JPEG_QUALITY"              => "75",
    "PDF_PDF_VERSION"               => "1.7",
    "PDF_PROTECTION"                => implode(",", ["print", "copy"]),
    "PDF_USER_PASSWORD"             => "",
    "PDF_OWNER_PASSWORD"            => "",
    "PDF_ACL_ACCESS"                => "detail",
    "PDF_ENCODING_TABLE_LIST"       => implode(",", [
        "cp1250",
        "cp1251",
        "cp1252",
        "cp1253",
    ...
    "PDF_ENCODING_TABLE_LABEL_LIST" => implode(",", [
