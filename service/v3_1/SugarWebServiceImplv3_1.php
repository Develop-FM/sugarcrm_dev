...
class SugarWebServiceImplv3_1 extends SugarWebServiceImplv3 {
    ...
    */
    ...
    function get_module_fields_md5($session, $module_name){
        ...
        Log::info('Begin: SugarWebServiceImpl->get_module_fields_md5(v3_1) for module: '. print_r($module_name, true));
        ...
        Log::info('End: SugarWebServiceImpl->get_module_fields_md5 (v3_1) for module: ' . print_r($module_name, true));
    ...
    function get_module_layout_md5($session, $module_name, $type, $view, $acl_check = TRUE){
    	Log::info('Begin: SugarWebServiceImpl->get_module_layout_md5');
    	$results = self::get_module_layout($session, $module_name, $type, $view, $acl_check, TRUE);
            return array('md5'=> $results);
    	Log::info('End: SugarWebServiceImpl->get_module_layout_md5');
    }
    ...
    */
    function get_entries($session, $module_name, $ids, $select_fields, $link_name_to_fields_array, $track_view = FALSE)
    {
        ...
        {
            Log::info('No Access: SugarWebServiceImpl->get_entries');
            return;
        } // if
        ...
        foreach($ids as $id)
        {
            ...
            Log::info('Should we track view: ' . $track_view);
            if($track_view)
            {
    ...
    {
        Log::info('Begin: SugarWebServiceImpl->get_language_file');
        global  $beanList, $beanFiles;
        ...
        {
            $error->set_error('invalid_login');
            Log::info('End: SugarWebServiceImpl->get_report_pdf');
            return;
        }
